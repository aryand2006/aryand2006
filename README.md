...
<p align="center">
  CS @ Carnegie Mellon (SCS) · ML &amp; CompFi<br/>
  QT/QR @ Wincent · systems &amp; quant verification
</p>
<p align="center">
  <a href="https://aryandaga.vercel.app">aryandaga.vercel.app</a>
  ·
  <a href="mailto:aryand@andrew.cmu.edu">aryand@andrew.cmu.edu</a>
  ·
  <a href="https://linkedin.com/in/aryan-daga">LinkedIn</a>
</p>
...
|------|------------|----------------|
| **[concord](https://github.com/aryand2006/concord)** | Raft KV + deterministic simulation | Seeded partitions/crashes; safety + linearizability. Same seed ⇒ same trace. |
...
| Repo | What it is |
|------|------------|
| **[affidavit](https://github.com/aryand2006/affidavit)** | Gate that swears a strategy result only after falsification checks (selection, costs, placebos, lookahead). |
| **[assay](https://github.com/aryand2006/assay)** | Did the result survive the search that found it? |
| **[parallax](https://github.com/aryand2006/parallax)** | How much of a backtest is engine choice vs strategy? |
